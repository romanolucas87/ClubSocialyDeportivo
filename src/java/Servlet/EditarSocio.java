...
//            out.println("</html>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Socio nuevoSocio = gestor.getSocioId(idSocio);
        request.setAttribute("modeloSocio", nuevoSocio); 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Socio nuevoSocio = new Socio(idSocio, nombreSocio, apellidoSocio, telefonoSocio, direccionSocio, fechaNacimiento, idNacionalidad, tipoDocumento, documentoSocio, email, true);

        ConexionJDBC gestor = new ConexionJDBC();
        gestor.modificarSocio(nuevoSocio);
