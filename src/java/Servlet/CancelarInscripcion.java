...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet CancelarInscripcion</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet CancelarInscripcion at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (modo == null || modo.isEmpty()) {
            ...
            gestor.bajaActividad(idSocio, idActividad);

            RequestDispatcher rd = request.getRequestDispatcher("FiltradoActividadSocio");
