...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet AltaActividad</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet AltaActividad at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/nuevaActividad.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double precioActividad = Double.parseDouble(request.getParameter("precioActividad"));
           ...
           Actividad nuevaActividad = new Actividad(nombreActividad, precioActividad, true);
